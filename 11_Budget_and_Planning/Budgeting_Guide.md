...
- **⚠️ Headline benchmark, from the source's own 60-object analysis**:
  ...
  before 2024-10-11 (90.0715 RUB/USD). [source: [[11_Budget_and_Planning/_supporting/knowledge/sources/YT_hfJa_QNaN6c_kruglov_consumables_25_percent_budget|hfJa_QNaN6c]]]
- Apartment/renovation insurance is optional and genuinely tricky —
  ...
  a post-hoc insurance claim. [source: [[11_Budget_and_Planning/_supporting/knowledge/sources/YT_hfJa_QNaN6c_kruglov_consumables_25_percent_budget|hfJa_QNaN6c]]]
...
- **Demolition/re-planning** — every wall moved is paid for four times (demolish, haul, rebuy, rebuild); working with the existing layout is the single biggest lever. [source: [[11_Budget_and_Planning/_supporting/knowledge/sources/YT_BMmPLHVmnqw_renovation_budgeting_interview|BMmPLHVmnqw_renovation_b]]]
- **Sourcing choices** — retail vs. wholesale materials, direct factory sourcing, and procurement specialists can shift costs significantly without changing the design. See §5 below for concrete tactics. [source: [[11_Budget_and_Planning/_supporting/knowledge/sources/YT_BMmPLHVmnqw_renovation_budgeting_interview|BMmPLHVmnqw_renovation_b]]]
...
2024-08-30 (89.9313 RUB/USD). [source: [[11_Budget_and_Planning/_supporting/knowledge/sources/YT_soshw_203eY_kruglov_how_much_modern_reno_costs|soshw_203eY]]]

### Live intake warning — estimate format (2025-08-01)

The same channel's contractor-model comparison warns against accepting an opaque “whole renovation for 20,000 RUB/m²” quote (≈**$240/m²** at the source-date trailing-six-month rate). The point is not that $240/m² is a valid benchmark; it is that a single floor-area number can hide stage scope, acceptance, defect correction, and payment milestones. Require an itemized estimate tied to defined stages before comparing contractor offers. This is a Moscow/company-level, commercially interested warning, not a universal market or legal rule. [source: [[11_Budget_and_Planning/_supporting/knowledge/sources/YT_3vIpdUvgWW0_kruglov_contractors_2025|source note]]]
...
- **Limit demolition/re-planning** — every wall moved is paid for four times; prefer smart zoning (slats/panels) over new walls. [source: [[11_Budget_and_Planning/_supporting/knowledge/sources/YT_BMmPLHVmnqw_renovation_budgeting_interview|BMmPLHVmnqw_renovation_b]]]
...
- **Use a procurement specialist ("комплектатор")** for expensive designer fixtures — often finds near-identical alternatives for a fraction of the cost. [source: [[11_Budget_and_Planning/_supporting/knowledge/sources/YT_BMmPLHVmnqw_renovation_budgeting_interview|BMmPLHVmnqw_renovation_b]]]
- **Buy rough materials wholesale**, e.g. via a contractor who supplies materials, rather than retail. [source: [[11_Budget_and_Planning/_supporting/knowledge/sources/YT_BMmPLHVmnqw_renovation_budgeting_interview|BMmPLHVmnqw_renovation_b]]]
- **Skip non-structural wardrobe backing panels** and order direct factory board-cutting — cuts custom millwork cost ~30%. [source: [[11_Budget_and_Planning/_supporting/knowledge/sources/YT_BMmPLHVmnqw_renovation_budgeting_interview|BMmPLHVmnqw_renovation_b]]]
- **Source lighting directly from overseas factories** — cuts hardware cost 50–70% vs. local resellers. [source: [[11_Budget_and_Planning/_supporting/knowledge/sources/YT_BMmPLHVmnqw_renovation_budgeting_interview|BMmPLHVmnqw_renovation_b]]]
- **Choose a 2-in-1 washer-dryer combo** over a separate dryer stack in comfort-class/space-constrained projects. [source: [[11_Budget_and_Planning/_supporting/knowledge/sources/YT_BMmPLHVmnqw_renovation_budgeting_interview|BMmPLHVmnqw_renovation_b]]]
- **Use online marketplaces (e.g. OZON)** for standard loose furniture items instead of custom/designer pieces. [source: [[11_Budget_and_Planning/_supporting/knowledge/sources/YT_BMmPLHVmnqw_renovation_budgeting_interview|BMmPLHVmnqw_renovation_b]]]
