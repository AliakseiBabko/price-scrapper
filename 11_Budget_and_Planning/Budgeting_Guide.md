...
- **Demolition/re-planning** — every wall moved is paid for four times (demolish, haul, rebuy, rebuild); working with the existing layout is the single biggest lever.
- **Sourcing choices** — retail vs. wholesale materials, direct factory sourcing, and procurement specialists can shift costs significantly without changing the design. See §5 below for concrete tactics.
...
- **Use a procurement specialist ("комплектатор")** for expensive designer fixtures — often finds near-identical alternatives for a fraction of the cost.
- **Buy rough materials wholesale**, e.g. via a contractor who supplies materials, rather than retail.
- **Skip non-structural wardrobe backing panels** and order direct factory board-cutting — cuts custom millwork cost ~30%.
- **Source lighting directly from overseas factories** — cuts hardware cost 50–70% vs. local resellers.
- **Choose a 2-in-1 washer-dryer combo** over a separate dryer stack in comfort-class/space-constrained projects.
- **Use online marketplaces (e.g. OZON)** for standard loose furniture items instead of custom/designer pieces.
- **Spray-paint existing PVC window frames** instead of replacing them (~$730 vs. $3,000+).
- **Substitute stretch ceilings and paintable wallpaper** for drywall ceilings and smooth painted walls — 40–60% labor/material savings.
- **Pay for rough materials directly through verified distributors**, not contractor cash advances, to avoid markup/fraud risk.
- **Consider a "micro-baseboard" instead of a fully concealed baseboard** — approximates the concealed look at a fraction of the installation cost and schedule time, trading a small amount of visual fidelity. *(secondary reference — see intermediate store)*
- **Question any "free" site consumables offer (added 2026-08-04)** — a temporary toilet/sink/shower and a wall-chasing dust extractor are billable customer consumables in reality, not free; companies advertising them as free are reported to mark up materials elsewhere by roughly 2x to cover the cost. A related concrete line item: hardboard sheeting to protect common-area walls during move-in/material delivery is worth budgeting for directly (~5,000 RUB) rather than risking a ~10,000 RUB damage-repair bill if skipped. `single-account`, `unverified`. [source: `90_Archive/processed_sources/20260804_first_shopping_list_consumables_78f45b8e.txt`]
- **Split rough and finish contracting into two separate hires (added 2026-08-04)** — the rough phase (demolition, framing, rough electrical/plumbing/heating, floor sound/waterproofing, screed) is the technically complex phase worth paying an experienced specialist crew for; the finish (cosmetic) phase is comparatively simple and can be done by a cheaper crew afterward without materially harming quality, since a well-executed rough phase is hard for a lesser finish crew to mess up. One company's own cited Moscow 2023 rough-only pricing: ~20,000 RUB/m² labor + ~13,000–16,000 RUB/m² rough materials over ~3–4 months, then ~2 more months for a cheaper finish crew. `single-account`, and note the company pitching this also profits more from selling the finish phase separately — weigh the incentive alongside the strategy. [source: `90_Archive/processed_sources/20260804_split_rough_finish_contracting_and_rough_stage_checklist_9a4efa5e.txt`]
