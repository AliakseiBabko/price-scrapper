...
- Should this store eventually get its own section in `Budgeting_Guide.md` or a separate top-level page, once it has enough corroborated content to be genuinely useful at a glance? Not decided — premature with only one source.
