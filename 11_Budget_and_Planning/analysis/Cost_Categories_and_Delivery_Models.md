# Renovation Cost Categories and Delivery Models

What the main cost categories are, why a turnkey figure and a self-managed figure are not comparable, what price-per-m² does and does not tell you, and what actually belongs in the rough-materials line. **Split out on 2026-09-02 under the vault's 300-line page ceiling, verbatim** — see the source page for the compact guide.

> [!IMPORTANT]
> **Read this before using any figure on [[11_Budget_and_Planning/analysis/Cost_Benchmarks_Live_Intake|Cost Benchmarks — Live Intake Ledger]].** Every benchmark there depends on knowing which delivery model and which scope it describes.
...
### ⚠️ 2.0c A designer regrets self-coordinating his OWN 55 m² flat — and it recalibrates the threshold below

**The strongest piece of evidence in this vault on what the coordination role actually is, because the person reporting it is the one best placed to do it himself, and it reflects badly on him.** [source: [[_Sources/YT_7zpsZtcTkCM_nsdsgn_own_flat_55m2_retrospective|YT_7zpsZtcTkCM]]]
...
- **He had the best individual specialist in each trade — and still concludes the coordination is a separate job that should have been bought.** So the failure was not the tradespeople and not the design; it was the absence of the sequencing role.
- **He is an interior designer with 15+ years of practice**, i.e. the person with the most relevant knowledge and the strongest incentive to believe he could manage it.
- **⚠️ AND IT RECALIBRATES THE THRESHOLD IN THE SECTION BELOW. That contractor puts the генподряд threshold at ~300 m² or a two-storey flat. This is 55 m². → The coordination requirement is not primarily AREA-driven — it is driven by the NUMBER OF INDEPENDENT SPECIALISTS who have to be sequenced.** A small flat assembled from many separately-hired best-in-trade specialists can need coordination more than a large flat built by one established crew. **Read the ~300 m² figure as "the area at which separate brigades stop working", not as "the area below which nobody needs coordinating".**
