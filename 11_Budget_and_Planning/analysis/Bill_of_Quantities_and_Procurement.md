# Where the Money Actually Goes — Bill of Quantities and Procurement Traps

A bill-of-quantities breakdown of where a renovation budget actually lands, the two procurement traps that change it, and two rules about where the money should go — including how designers defraud clients and the questions that prevent it. **Split out on 2026-09-02 under the vault's 300-line page ceiling, verbatim** — see the source page for the compact guide.
