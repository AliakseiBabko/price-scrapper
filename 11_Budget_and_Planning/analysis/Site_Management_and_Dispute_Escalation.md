# Site Management and Dispute Escalation

Running the job once it has started — the client's own presence, communication with adjacent trades, third parties and the building's management — and what to do when the damage is real: who may judge it, and the routes to recourse.

**Extracted from [[11_Budget_and_Planning/analysis/Contract_Practice|Contract Practice]] on 2026-09-03.** These are execution-phase and failure-phase decisions rather than contract terms, and the worked failure cases belong with the escalation procedure they justify.

## Running the Job — Presence, Communication and Third Parties

How the client's own conduct, the adjacent trades and the building's management change the cost and the schedule.
...
### ⚠️⚠️ Materials Bought THROUGH the Contractor Become Hostages — Whose Name Is on the Supply Contract (Владимир Калинин, 2026-06-16)

**On dismissal, the contractor retained materials the client had already paid for: European lighting, finish sanitaryware, smart-home controllers and servers.**

- → **⚠️⚠️ THE STRUCTURAL POINT, AND IT IS THE MOST DIRECTLY ACTIONABLE ITEM IN THE SOURCE: WHAT MATTERS IS WHOSE NAME IS ON THE SUPPLY CONTRACT.** Materials procured *through* a contractor sit in his possession and often in his name, **so they become leverage at exactly the moment the relationship fails** — which is the moment you need them most.
- → **Buy long-lead and high-value equipment on the CLIENT'S own contract, delivered to the client, even when the contractor offers to handle it.** This is decided at procurement and is irreversible afterwards.
- ⚠️ **AND IT IS A GENUINE TRADE-OFF, not a free win: contractor procurement buys coordination, trade pricing and single-point responsibility, and costs you CUSTODY.** The vault records the convenience case elsewhere; **both stand, and the choice should be made knowingly per category — custody matters most for the items that are expensive, long-lead and irreplaceable.**
- ⚠️ **Pair with the Round 6 procurement finding that many factories store purchased material FREE, which lets a client fix a price early without taking delivery** — see [[11_Budget_and_Planning/analysis/Cost_Categories_and_Delivery_Models|Cost Categories and Delivery Models]]. **Together the two give the complete rule, and neither source states both halves: fix the price early, in your own name, stored at the factory.**

### ⚠️⚠️ A Contractor's Planning Horizon Ends at His Warranty — the General Mechanism Behind a Whole Class of Defects

**On the same build, AC and ventilation access hatches were provided only to the FILTERS, not to the equipment behind them. The previous crew's reasoning: «ну, если сломается, то сломается, будут ломать потолок».**

**⚠️⚠️ The designer's incentive analysis, which is the best general idea in the source: A CONTRACTOR'S PLANNING HORIZON ENDS AT HIS WARRANTY PERIOD. Anything that fails after it is not a cost to him — so SERVICEABILITY, which by definition only pays off later, is SYSTEMATICALLY UNDER-PROVIDED, and no amount of goodwill fixes a horizon mismatch.**

- → **⚠️ This is a single explanation for a whole class of defects the vault currently records one at a time: unreachable valves, buried junction boxes, no hatch to a pump, hatches sized for the wrong component.** They are not carelessness; they are a rational response to a shorter horizon than the client's.
- → **The consequence for the client: serviceability items must be SPECIFIED AND CHECKED BY THE CLIENT OR THE SUPERVISOR, because the contractor's interests do not reach them.** It cannot be delegated to the party whose horizon excludes it.
- ⚠️ **It also supplies the missing WHY for the serviceability definition recorded in Round 4** — the vault had the principle and not the reason anyone would violate it.

### ⚠️ A Rescue Is a Probability Purchase, Not a Fix (same source)

A garage converted to a habitable room, found with **the wrong-size window frame, undried timber, and no insulation to the facade or to the I-beam.** His prediction as found: **it will twist and the glazing will burst.** His actual intervention: screw-fix and insulate what could be reached — **«А ДАЛЬШЕ УЖЕ КАК ПОВЕЗЁТ».**

- → **⚠️ Worth recording verbatim because the professional verdict on a remediated unsound build is “and after that, luck”. Remediation on top of an unsound build buys probability, not soundness** — which is the strongest available argument for spending on control DURING the build rather than on rescue after it.
...
What to do when the damage is real, who must not be asked to judge it, and the cases that show how far upstream the failure began.
...
- [[11_Budget_and_Planning/analysis/Contract_Practice|Contract Practice]] — the clauses that prevent most of what is on this page
- [[11_Budget_and_Planning/analysis/Contractor_Vetting_and_Selection|Contractor Vetting and Selection]]
