...
How to judge a contractor before signing: the red flags, the behavioural green flags, what a site visit can and cannot tell you, and the signals practitioners themselves reject as worthless.

**Extracted from [[11_Budget_and_Planning/analysis/Contract_Practice|Contract Practice]] on 2026-09-03.** Selection happens before there is a contract at all, uses different evidence, and had grown into the largest block on a page that was a single undifferentiated list.

## Vetting and Selecting a Contractor

What to check before signing, which signals actually carry information, and which the practitioners themselves reject.
...
### ⚠️⚠️ The Criterion Is the RESPONSE to a Defect, Not Its Absence — and This Round Supplies Both Ends of the Axis

**This page is rich in red flags and thin on what a good answer actually looks like. Two Round 6 sources give the two ends of one axis, and the pair is far more useful than either alone.**

**THE CRITERION — a furniture works manager on his own defects: «ЧЕЛОВЕЧЕСКИЙ ФАКТОР ПРИЗНАЮ, ЕСТЬ. Но самое главное — МЫ ПРИЗНАЁМ И ИСПРАВЛЯЕМ.»** Generalised by the designer interviewing him:

**«ОЧЕНЬ ВАЖНО, ЧТОБЫ ПРОИЗВОДИТЕЛИ В ЛЮБОЙ ВООБЩЕ СФЕРЕ ИНТЕРЬЕРА ПРИЗНАВАЛИ СВОИ КОСЯКИ И ИСПРАВЛЯЛИ ИХ, ПОТОМУ ЧТО ОНИ БЫВАЮТ ВЕЗДЕ. НО ЕСТЬ ЛЮДИ, КОТОРЫЕ ПРОСТО ИСЧЕЗАЮТ, и вы просто НИЧЕГО НЕ МОЖЕТЕ СДЕЛАТЬ. А есть производители… которые ВСЕГДА ВСЁ ИСПРАВЛЯЮТ и доводят до финального результата — ПОЭТОМУ У НИХ ВСЕГДА МНОГО РАБОТЫ.»** [source: [[_Sources/YT_P3O2koqOGp8_nsdsgn_carcass_furniture_production|YT_P3O2koqOGp8]]]

- → **⚠️ DEFECTS ARE UNIVERSAL, SO A CLAIM OF NO DEFECTS IS NOT A SIGNAL. The signal is what happens after one.** And the observable proxy he offers — **a full order book** — independently matches this page's existing green flag that a good specialist is always booked.
- **⚠️ THE WORST OUTCOME, COSTED: the vanishing case.** A contractor on a 400 m² build who blackmailed the client («если вы мне сейчас не заплатите, у меня отсюда уйдёт бригада»), took a **3-million-of-10-million self-allocated “salary” (≈$39,100 of ≈$130,000)**, never removed four skips of waste he had been paid to remove, left rooms physically inaccessible — and **is now wanted by police, with 58m ₽ (≈$756,000) wasted and 15m ₽ (≈$196,000) of materials money simply gone.** [source: [[_Sources/YT_HbQHuyokSd0_nsdsgn_rescue_contractor_58m_dispute|YT_HbQHuyokSd0]]]
- → **Route the two together. The criterion is cheap to apply and the failure is unrecoverable, which is the whole argument for applying it.**

### ⚠️ The Victim Profile — Four Attributes, and Only the Fourth Is Operative

Offered by the same rescue contractor as the pattern that makes a client vulnerable: **(1) wealthy**, so individual overpayments do not register; **(2) accustomed to being served**, so used to delegating; **(3) emotionally invested**; and **(4) ⚠️ ABSENT.**

- → **⚠️ The fourth is the operative one and the first three merely explain it. EVERY failure on that build was one a present, mildly sceptical client would have caught within a week: skips standing in a room, no board lifter on site the day the ceiling went up, frames set before the floor existed.**
- → **So this belongs on this page as a MECHANISM rather than a character sketch: vetting reduces the probability of a bad contractor; presence is what limits the damage when vetting fails.** It also sharpens this page's existing material on client site attendance, which argues (correctly, from a different source) that ANXIOUS DAILY attendance is itself costly — **the reconciliation is stage-end inspection rather than either absence or hovering, and that is already recorded at [[11_Budget_and_Planning/analysis/Site_Management_and_Dispute_Escalation|Site Management and Dispute Escalation]].**
