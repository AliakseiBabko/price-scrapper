...
<table style="width: 100%; table-layout: fixed; border-collapse: collapse; text-align: left; word-break: break-word;">
  <thead>
    <tr style="border-bottom: 2px solid var(--border-color, #ccc); background-color: var(--background-secondary, #f9f9f9);">
      ...
      <th style="width: 22%; padding: 8px;">⚡ Set 2 (Electrolux Touch)</th>
      <th style="width: 22%; padding: 8px;">⚖️ Set 3 (Bosch Manual)</th>
  ...
  <tbody>
    ...
    <tr style="border-bottom: 1px solid var(--border-color, #eee);">
      ...
      <td style="padding: 8px;">Bosch SMV4EVX00E (2,099 BYN)</td>
    ...
    <tr style="border-bottom: 2px solid var(--border-color, #ccc); font-weight: bold; background-color: var(--background-secondary, #f9f9f9);">
      ...
      <td style="padding: 8px;">8,515 BYN</td>
...
## 2. ⚡ Set 2: "Electrolux Touch" (All-Black Glass with Full Touch)
...
## 3. ⚖️ Set 3: "Bosch Manual" (Balanced Quality)
**Target**: Total budget **8,515 BYN** — saves ~5,368 BYN compared to Set 1 while retaining Bosch quality, Pyrolysis, and auto-door open drying.
...
* **Dishwasher (Bosch SMV4EVX00E - 2,099 BYN)**: Mid-range Serie 4 model featuring **EfficientDry** (auto-door opening at the end of the cycle for enhanced drying), a VarioDrawer 3rd cutlery rack, InfoLight floor projection dot, and quiet 44 dB operation.
