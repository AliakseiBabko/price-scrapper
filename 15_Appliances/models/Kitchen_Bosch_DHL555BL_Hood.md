...
* **⚠️ Real-world throughput may be far below 618 m³/h regardless of ducting — check this before assuming the rated spec applies**:
   - **Detail**: A shared apartment-building ventilation shaft, not the hood, is typically the actual bottleneck on extraction-mode airflow — ex-Soviet-bloc shafts are commonly rated only ~100-120 m³/h, roughly a sixth of this hood's rated capacity, regardless of how well the hood's own ducting is installed. There is also an unresolved question of whether extraction-to-shaft venting is even permitted for this development (see below). See [[15_Appliances/analysis/Kitchen_Hood_Analysis]] §4 for the full analysis and what to verify for this specific apartment before treating 618 m³/h as achievable.
