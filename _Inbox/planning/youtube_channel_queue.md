...
- **Petrishin-Stroi** — ACTIVE. Rounds 1-6 complete 2026-08-24 (45 videos, 425 new facts). Yields: 8.6, 9.5, 8.9, 11.1, 8.75, 9.5 facts/video — Round 6 recovered to 109% of Round 5's baseline (case-study/cost-benchmark/named-technique selection continues to outperform general recap formats). Round 6 highlights: a 4th and a 5th real cost-benchmark data point (a 120m² labor-only total and a 38m² full-scope budget case, both kept separate from the existing rough-stage-only series on scope grounds), a direct follow-up video on the same real object as Round 4's historic-Arbat case (closing part of its cost/area gap), and an explicit 2024-vs-2025 market-tier cross-check that found a scope/methodology difference rather than a clean year-over-year comparison. See `petrishin_stroi_channel_plan_20260824.md`. Round 7 next — 296 of 341 videos still remain.
