...
- **Petrishin-Stroi** — ACTIVE. Rounds 1-7 complete 2026-08-24 (53 videos, 487 new facts). Yields: 8.6, 9.5, 8.9, 11.1, 8.75, 9.5, 7.75 facts/video — Round 7 at 82% of Round 6's baseline, within the >50%-drop stop-and-ask threshold and well above the 1.0 floor (case-study/cost-benchmark/named-technique selection continues to outperform general recap formats). Round 7 highlights: a 7th real cost-benchmark data point (5,250,000 RUB / 54m² / confirmed-2023 full-turnkey total, ≈$78,700/≈$1,500/m², kept separate from the existing series on scope grounds), two explicit cross-checks that both confirmed no unwanted overlap (mechanized-putty video vs. Rounds 1-3's plastering/squareness content; wall-crack video vs. Round 1's masonry acceptance video and the deformation-seam mechanism — confirmed a 3rd recurrence, correctly excluded from the fact count), and a room-tour video explicitly checked against and correctly **not** force-fit into the cost-benchmark series (no spoken total despite a stated floor area). See `petrishin_stroi_channel_plan_20260824.md`. Round 8 next — 288 of 341 videos still remain.
