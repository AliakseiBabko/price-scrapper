...
- **Petrishin-Stroi** — ACTIVE. Rounds 1-2 complete 2026-08-24 (13 videos, 119 new facts). Round 1 yield 8.6 facts/video, Round 2 yield 9.5 facts/video — verdict confirmed: full-scale processing, no format deprioritization needed (the channel's "Как убить X" clickbait format spot-checked positive, on par with its named-technique series). See `petrishin_stroi_channel_plan_20260824.md`. Round 3 next.
- **RemProektMD** — ACTIVE. Round 1 trial (5 videos) complete 2026-08-24, yield 7.0 facts/video, verdict: full-scale processing recommended. See `remproektmd_channel_plan_20260824.md`. **Scope flag, still worth the user's attention**: this is a Moldova (Chisinau) company channel, a new country/currency for this project — no MDL rate support in `currency_converter.py`; the one priced trial video turned out to quote EUR (also unsupported), recorded raw/not-converted rather than guessed. Technique content is unaffected and has already produced a genuine cross-channel corroboration (polypropylene pipe joint defect). Round 2 next — title-skim showed a heavy repetitive "yearly trend showcase" cluster (2023/24/25/26 versions of similar content) worth a light dedup-aware pass rather than full individual processing.
