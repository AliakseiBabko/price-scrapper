...
- **Petrishin-Stroi** — ACTIVE. Rounds 1-11 complete 2026-08-24 (82 videos fetched/extracted + 3 genuinely skipped for no captions, 759 new facts). Yields: 8.6, 9.5, 8.9, 11.1, 8.75, 9.5, 7.75, 7.6, 9.5, 9.6, 10.9 facts/video — Round 11 at 114% of Round 10's baseline, well above the 1.0 floor, no stop-and-ask trigger. Round 11 highlights: an unusually old 2016-2018 source cluster (vs. 2022+ for every prior round), including this channel's oldest source to date (2016, requiring a one-time USD/RUB 2016 exchange-rate backfill); two explicit cross-checks both confirming genuinely distinct methods rather than restatements — a "струнные маяки" (string-beacon) plastering-reference technique vs. every prior rigid-strip-beacon source on this channel, and a ZIPS-panel wall-soundproofing product vs. Round 10's frame-system soundproofing mechanism (same manufacturer, same underlying decoupling principle, genuinely different installation method); a novel curved/radius-wall beacon-fabrication technique (bent metal-plastic pipe wired to screws, packed with plaster); a real, candidly-still-open internal company dispute over water-hammer-compensator placement; and a probable (not certain) same-real-project link discovered between two videos filmed ~2 weeks apart. One video (paint/decorative-plaster masterclass) hit a genuine no-captions failure. See `petrishin_stroi_channel_plan_20260824.md`. Round 12 next — 256 of 341 videos still remain (341 − 85 manifest entries touched across Rounds 1-11, counting the 3 skips).
