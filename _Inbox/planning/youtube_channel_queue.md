...
- **Petrishin-Stroi** — ACTIVE. Rounds 1-4 complete 2026-08-24 (29 videos, 279 new facts). Yields: 8.6, 9.5, 8.9, 11.1 facts/video (Round 4 highest yet) — every format spot-checked on this channel so far ("Как убить X" clickbait, "СРАВНЕНИЕ!" comparisons, foreman-interview case studies) has been substantive; only the one client-satisfaction-testimonial video tested (Round 4 video 8) was thin. See `petrishin_stroi_channel_plan_20260824.md`. Round 5 next — 312 of 341 videos still remain.
