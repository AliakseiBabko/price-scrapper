...
- **Petrishin-Stroi** — ACTIVE. Rounds 1-10 complete 2026-08-24 (75 videos fetched/extracted + 2 genuinely skipped for no captions, 683 new facts). Yields: 8.6, 9.5, 8.9, 11.1, 8.75, 9.5, 7.75, 7.6, 9.5, 9.6 facts/video — Round 10 at 101% of Round 9's baseline, well above the 1.0 floor, no stop-and-ask trigger. Round 10 highlights: a real radiator-fitting flood incident with a genuinely new liability-determination mechanism (which specific pipe connection failed, and was that the one the contractor actually worked on) distinct from this channel's towel-warmer and ventilation-defect flood mechanisms; a real electrical floor-vs-ceiling wiring-routing decision framework with a rare arithmetic-checkable worked cost comparison (≈62,000 RUB difference on one real object); and a pair of companion wall/ceiling soundproofing-frame installation videos confirmed as the first genuinely systematic soundproofing-installation technique source on this vault, surfacing the concrete construction step (temporary, removable perimeter anchors) behind the "vibration-damping hangers decouple the frame from structure" mechanism previously only described abstractly. Two trade-show/showroom videos (1, 2) were given partial extractions per the value-filter rule; one dedicated baseboard video (3) hit a genuine no-captions failure, incidentally and partially compensated for by video 4's own baseboard content. See `petrishin_stroi_channel_plan_20260824.md`. Round 11 next — 264 of 341 videos still remain (341 − 77 manifest entries touched across Rounds 1-10, counting the 2 skips).
