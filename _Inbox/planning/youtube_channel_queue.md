...
- **Petrishin-Stroi** — ACTIVE. Rounds 1-8 complete 2026-08-24 (60 videos fetched/extracted + 1 genuinely skipped for no captions, 540 new facts). Yields: 8.6, 9.5, 8.9, 11.1, 8.75, 9.5, 7.75, 7.6 facts/video — Round 8 at 98% of Round 7's baseline, well within the >50%-drop stop-and-ask threshold and well above the 1.0 floor (case-study/cost-benchmark/named-technique selection continues to outperform general recap formats). Round 8 highlights: a genuine no-captions failure correctly distinguished from a rate-limit (video 4, noise-law/quiet-hours — both `youtube-transcript-api` and `yt-dlp` failed with `reason_class: null`, logged `skipped`, not left pending); a **Perspectives disagreement surfaced and recorded** on window profile/hardware brand mattering (this round's video 2 vs. the existing Zemskov claim); three explicit cross-checks that all resolved cleanly (foam-block masterclass vs. Round 1's masonry acceptance video — complementary, not duplicate; monolith electrical vs. existing electrical-sequencing content — genuinely new sub-topic including a novel phase-loss/neutral-disconnection 380V failure mechanism; finishing tips vs. Round 7's and Round 2's finishing/wallpaper videos — no overlap); and a title/format-mismatched client-testimonial interview correctly given only a partial low-value extraction. See `petrishin_stroi_channel_plan_20260824.md`. Round 9 next — 280 of 341 videos still remain (341 − 61 manifest entries touched across Rounds 1-8, counting the 1 skip).
