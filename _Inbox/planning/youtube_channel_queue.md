...
- **Petrishin-Stroi** — ACTIVE. Rounds 1-5 complete 2026-08-24 (37 videos, 349 new facts). Yields: 8.6, 9.5, 8.9, 11.1, 8.75 facts/video — Round 5's yield (79% of Round 4's peak) is the first sign this channel's marginal yield is starting to soften on general "top N mistakes"/"all stages" recap formats (videos 6 and 8 posted this channel's lowest-ever per-video yields, 8 and 4, from heavy same-channel restatement), while named-technique/case-study/comparison formats and even a comment-response Q&A sub-format (video 3, discovered this round) still yield well. See `petrishin_stroi_channel_plan_20260824.md`. Round 6 next — 304 of 341 videos still remain.
