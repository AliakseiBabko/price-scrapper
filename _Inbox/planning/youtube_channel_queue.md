...
- **Petrishin-Stroi** — ACTIVE. Rounds 1-9 complete 2026-08-24 (68 videos fetched/extracted + 1 genuinely skipped for no captions, 616 new facts). Yields: 8.6, 9.5, 8.9, 11.1, 8.75, 9.5, 7.75, 7.6, 9.5 facts/video — Round 9 at 125% of Round 8's baseline, well above the 1.0 floor, no stop-and-ask trigger. Round 9 highlights: a genuinely valuable, not-yet-seen "6-years-later revisit" format (video 2) uncovering a real concealed-ventilation-valve defect and a management-company sign-off gap; a real 4-material partition-wall comparison with actual dB sound-insulation figures and market pricing quantifying this channel's existing qualitative rankings; a bathroom-ceiling-specific comparison (slatted/cassette/glass-mirror) with a named collaborating design blogger; a title/format-mismatched trade-show tile-expo tour correctly given only a partial extraction; and an explicit cross-check confirming the construction-sink build-instructions video is a distinct source from (not the origin of) this channel's existing construction-sink mention on `Demolition.md`, adding a wholly new tile-adhesion defect mechanism (dirty wet-cut tile bonding to its own dried slurry) in the process. See `petrishin_stroi_channel_plan_20260824.md`. Round 10 next — 272 of 341 videos still remain (341 − 69 manifest entries touched across Rounds 1-9, counting the 1 skip).
