...
## Cable and Circuit Design

**Merged 2026-09-02.** These sections arrived in separate processing batches and each appended its own dated heading. They are grouped here by subject; the original dated headings are **demoted to `###`, not deleted**, so every attribution and date survives. No prose changed.
...
## Routing — Walls, Floors, Ceilings and Documentation
...
## Room-Specific Rough-In and Grounding
...
## Conduit, Fire Behaviour and Standards
