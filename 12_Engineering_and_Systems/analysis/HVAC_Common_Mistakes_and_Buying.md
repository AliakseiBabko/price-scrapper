...
2. **Poor indoor-unit placement** — installing it so it blows directly on occupants (see [[12_Engineering_and_Systems/analysis/AC_Key_Concepts_and_Placement|Key Concepts & Indoor Unit Placement]]).
...
- **Warranty structure**: buying equipment and installation as one package from a single vendor is the practical way to get a bundled warranty — check whether a quoted warranty period covers both equipment and installation, or just one.
