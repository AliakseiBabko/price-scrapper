...
**Split-system AC** is the standard residential setup: an indoor unit (produces cold air, mounted in the room) and an outdoor unit (rejects heat, mounted on the facade/balcony), connected by pressurized refrigerant lines plus a condensate drain from the indoor unit.
