...
## System Types and Their Hard Limits

Which architecture is appropriate, and where each one stops working.
...
## Indoor Units — Types, Placement and Concealment

What the indoor unit can be, where it may go, and what must never be done to hide it.
...
## Outdoor Units — Placement, Constraints and Serviceability

Where the outdoor unit may go, what forbids each option, and what each choice costs in money or in access.
...
- **⚠️ Vertical position in the building is a cost driver, with a worked case.** A flat on the **2nd floor of a ~12-storey building** needed **a very expensive outdoor unit purely to pump the whole freon line** up to the available mounting position — «это прямо обошлось очень дорого, но другого варианта не было». **So a low floor with only roof-level mounting available carries an equipment premium, not just a longer run.**
- **⚠️ A protected facade is a hard prohibition, not a negotiation: «если дом находится на какой-то центральной улице, то фасад скорее всего будет защищён законом, и вам просто не разрешат расположить на нём наружный блок».** Must be agreed with the управляющая компания in every case. *(Jurisdiction is Russia — see the standing rule that a Russian-sourced regulatory claim stays on the technical page with the jurisdiction flagged, never in `16_Legal_and_Regulations/`.)*
- **The mechanism behind the balcony objection, stated memorably: the outdoor unit rejects as much heat as the cold it delivers inside — so putting it on your own balcony creates «маленький филиал Дубая», «останется только насыпать песочек и привязать верблюда».** *(Corroborates this page's existing balcony-placement usability tradeoff.)*
- Modern buildings frequently provide **baskets under the windows** or a dedicated **сплит-шахта** holding all the outdoor units. Roof mounting requires an upper-floor flat.

**Indoor-unit notes from the same source, mostly corroborating this page's taxonomy, with two additions worth keeping:** **floor-ceiling units are rare in practice — «я встречал их буквально один или два раза»**; and **the cassette unit is «на порядок больше» — an order of magnitude dearer than a wall unit — and is really intended for industrial spaces.** **The most aesthetic option he names is a ducted indoor unit hidden above the ceiling distributing via the vent channels: dearer, eats ceiling void, but integrable with the ventilation system** — which is the integration the combined slot diffuser on [[13_Surfaces_and_Finishes/analysis/Ceiling_Type_Comparison_and_Cost|Ceiling Type Comparison and Cost]] exists to serve.

**And the misconception he says he must correct with every client: «самое большое заблуждение — думать, что из кондиционера поступает свежий воздух. Ему там просто неоткуда взяться.»** Ventilation supplies air; conditioning changes its temperature. Expensive systems carry both blocks plus ionisation and humidification alongside, **which is what creates the impression of one machine.**
...
What has to be decided at rough stage even when the equipment is bought later.
