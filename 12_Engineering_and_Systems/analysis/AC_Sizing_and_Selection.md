...
Zemsproekt / Zemstandart (Alexey Zemskov, with Sergey Saratov identified in the note) says **the kitchen-specific multiplier, added 2026-08-19, is**: apply the standard bedroom/kids-room formula above, then **multiply by 1.5×** for a kitchen — kitchens carry meaningfully more heat sources (appliances, cooking) than a same-area bedroom, and sizing with the unmultiplied formula runs the unit permanently near its capacity ceiling, causing premature failure. [source: [[_Sources/YT_fSEPr5fpfPM_kitchen_stubouts_ac_fridge_niche_166|note]]]
...
[source: [[_Sources/YT_WK-KLd2ssYY_kruglov_ac_economy_vs_premium|WK-KLd2ssYY]]]
