...
Full detail in the
[[_Sources/YT_AcibYG4jtbs_zlobin_bedroom_layout_part1_theory|source extraction note]].
...
[[_Sources/YT_lA7RJiDJLkQ_zlobin_bedroom_layout_part2_practice_10x10house|source extraction note]].
...
Full detail in the
[[_Sources/YT_h_o3RrQ9z40_zlobin_guest_room_theory_multifunctional|source extraction note]].
...
- **Wardrobe mirror placement**: never install mirrored wardrobe-door panels facing the bed — peripheral-vision motion from mirrors facing the sleep area is a real, common-enough discomfort that ~65% of this practitioner's clients ask to swap mirrored panels for frosted/matte ones after living with it. Mirrors should face *into* the closet, not out toward the room. [[_Sources/YT_8odGOTVAuIk_bedroom_mistakes_client_testimonial|source note]]
- **Walk-in-closet mirror clearance formula** (if a walk-in closet is built with an internal mirror): minimum width = 1m (mirror standing clearance) + 60cm (clothing zone) + 10cm (sliding-door track) = **1.7m minimum**. Below that, don't build a walk-in with an internal mirror. [[_Sources/YT_8odGOTVAuIk_bedroom_mistakes_client_testimonial|source note]]
- **Walk-in-closet access point**: enter from a shared hallway/vestibule, not from inside the bedroom itself — preserves the bedroom's own wall space for a proper wardrobe with mirrored doors, without sacrificing the closet's privacy (a closed door already grants that). [[_Sources/YT_u28Gqg_V7eE_walkin_access_from_hallway_not_bedroom|source note]]
- **Don't shrink a bedroom to bring the TV closer** — compensate for viewing distance with a larger TV instead; keep the room's full usable size. [[_Sources/YT_8odGOTVAuIk_bedroom_mistakes_client_testimonial|source note]]
...
- **Irregular-shell bedroom techniques** (trapezoidal rooms, curved walls, acute/obtuse corners): see [[_Sources/YT_RF6FdHk_jgE_wildest_one_bedroom_trapezoid_layout|source note]] for a full worked case — relevant if either phase's actual room geometry turns out non-rectangular.
- **Fold-away-bed-into-storage-wall technique (directly relevant to Phase 2)**: a bed that folds into a wall/storage unit can convert a room into flexible-use space on demand — a real client wishlist item, initially assumed impossible to fit, solved this way. [[_Sources/YT_JwB6L-tYd7I_designer_dunk_400k_replan_254|source note]]
...
[[_Sources/YT_a_i8pGVa7-w_kruglov_bedroom_mistakes|source extraction note]]; summarized here:
...
[[_Sources/YT_BFbNL-DjDh4_kruglov_top_bedroom_solutions|source extraction note]].
...
[[_Sources/YT_HGN_3WeL0Jk_kruglov_moscow_city_35sqm_tour|source extraction note]]
...
[[_Sources/YT_gWAOrislxFY_timremont_bedroom_a_to_z|source extraction note]],
...
[[_Sources/YT_U95vMOOhKH8_timremont_39sqm_walkin_office_zoning|source extraction note]].
...
level) is in
[[_Knowledge/store/Numeric_Data|Numeric Data]]
and the
[[_Sources/YT_L0kI_PZKvmQ_petrishin_bedroom_cost_standard_premium_2022|source extraction note]].
...
in the
[[_Sources/YT_1_nKzwNZD6w_petrishin_windowless_bedroom_replan|source extraction note]].
...
- **One core mechanism scales across bed sizes and orientations**: the
  ...
  the same mechanism. [source: [[_Sources/YT_viWTUee1PUY_furniteka_bed_lift_mechanism_overview|YT_viWTUee1PUY]]]
- **⚠️ Gas-strut force-rating selection risk, corroborated twice**: the
  ...
  product against. [source: [[_Sources/YT_9jDv0Iibbfw_furnitura_dv_wallbed_drawbacks_mechanism|YT_9jDv0Iibbfw]]], [source: [[_Sources/YT_ldTVukHRIR0_kalibroomtv_gas_lift_selection|YT_ldTVukHRIR0]]]
- **⚠️ Gas-strut installation-order distinction, easy to get backwards**:
  ...
  with the bed CLOSED. [source: [[_Sources/YT_viWTUee1PUY_furniteka_bed_lift_mechanism_overview|YT_viWTUee1PUY]]]
...
- **Documented failure mode, correlated with daily use**: a
  ...
  connection point. [source: [[_Sources/YT_9jDv0Iibbfw_furnitura_dv_wallbed_drawbacks_mechanism|YT_9jDv0Iibbfw]]]
- **A real 2.5-year DAILY-use counter-example, same practitioner**: a
  ...
  practitioner). [source: [[_Sources/YT_vFd4E6F6Z3Q_furnitura_dv_wallbed_2_5_year_review|YT_vFd4E6F6Z3Q]]]
- **⚠️ A steel-tube frame as a structural solution to this exact weak
  ...
  particleboard or steel tube. [source: [[_Sources/YT_Gy68fsIdDLY_fursov_wallbed_transformer_case|YT_Gy68fsIdDLY]]]
- **Cross-bar/center-support structural detail, a real quality check**:
  ...
  important by one maker. [source: [[_Sources/YT_Gy68fsIdDLY_fursov_wallbed_transformer_case|YT_Gy68fsIdDLY]]]
...
- **For straps**: standard kits include three sets of mattress/bedding
  ...
  when raised. [source: [[_Sources/YT_9jDv0Iibbfw_furnitura_dv_wallbed_drawbacks_mechanism|YT_9jDv0Iibbfw]]], [source: [[_Sources/YT_Gy68fsIdDLY_fursov_wallbed_transformer_case|YT_Gy68fsIdDLY]]]
- **Against straps**: one maker's own design instead holds the mattress
  ...
  the strap approach. [source: [[_Sources/YT_wfmIOYsE2Hs_freedom_wallbed_living_bedroom_combo|YT_wfmIOYsE2Hs]]]
...
sources are excluded as branded promotion. [source: [[_Sources/YT_ldTVukHRIR0_kalibroomtv_gas_lift_selection|YT_ldTVukHRIR0]]], [source: [[_Sources/YT_gUY1BE4b_eA_armos_top5_lift_beds|YT_gUY1BE4b_eA]]]
