...
| **Developer's detailed plan — VECTOR** | `_Inbox/_Visual_Drop/3Б_3+ МН5_287.pdf` | **The same drawing as the base case, as CAD geometry.** Chain reading without a raster. Issued for another unit — see below |
