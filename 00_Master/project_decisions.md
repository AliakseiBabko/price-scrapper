...
- **✅⚠️⚠️ NO NATURAL GAS IN THE BUILDING AT ALL — electric stoves only. Stated by the owner, 2026-09-08.** This was an open question as recently as the same day, and it settles more than it looks:
  ...
  - **⚠️ But the electrical design load gets MORE binding, not less.** § 4 prohibits exceeding the premises' **calculated engineering load**, and with no gas the **entire cooking load** sits on the electrical figure — alongside any underfloor heating and the full appliance set. **Check the design figure before committing to hob + oven + underfloor heating together.** This is a number to obtain, not a permit to apply for — see [[16_Legal_and_Regulations/analysis/Renovation_Permits_and_Approvals|Renovation Permits and Approvals]].
