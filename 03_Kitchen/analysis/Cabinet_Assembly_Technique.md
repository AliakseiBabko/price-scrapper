# Kitchen — Cabinet & Countertop Assembly Technique

Installation sequence, module assembly, countertop joining and on-site QC — the self-managed and supervision-relevant layer. **Split out of `03_Kitchen/Kitchen_Furniture.md` on 2026-09-02, verbatim.**

Related: [[11_Budget_and_Planning/Renovation_Sequence|Renovation Sequence]] for when furniture is commissioned relative to the build, and the blocking/backing requirements a fabricator needs before installation.
