# Kitchen — Cost, Priorities & What to Cut

Where to spend and where not to on a kitchen specifically, with the priced add-ons and the cost-saving techniques. **Split out of `03_Kitchen/Kitchen_Furniture.md` on 2026-09-02, verbatim.**

Related: [[11_Budget_and_Planning/analysis/Budget_Tiers_Cheap_Optimal_Premium|Budget Tiers]] for the per-system tier ladder and whole-project anchoring, and [[11_Budget_and_Planning/analysis/cost_saving_strategies_full|Cost Saving Strategies]] for the replaceable-versus-buried spend principle this page's choices sit under.
