# Kitchen Facades — A Fabricator's Own Account

One furniture manufacturer's account of the materials he works in, across three videos: fine-line veneer and how it is mis-sold, массив deconstructed, batch-matching, stone-facade mounting engineering, and four years of field evidence from his own flat. **Split out on 2026-09-02 under the vault's 300-line page ceiling, verbatim** — see the source page for the compact guide.

> [!NOTE]
> **Kept together deliberately.** These three blocks are one source's single argument, and the earlier decision not to split this material was made precisely because the substrate/facing/hardware seams cut *through* sourced blocks rather than between them. Moving the fabricator's account out whole respects that — **[[03_Kitchen/analysis/Furniture_Facade_Materials|Facade Materials]] keeps the multi-source tier ladders it is compared against.**
