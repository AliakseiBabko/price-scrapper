...
<table style="width: 100%; table-layout: fixed; border-collapse: collapse; text-align: left; word-break: break-word;">
  ...
  <tbody>
    ...
    <tr style="border-bottom: 1px solid var(--border-color, #eee);">
      ...
      <td style="padding: 8px;">Bosch BFL524MS0 (1,014 BYN)</td>
    ...
    <tr style="border-bottom: 2px solid var(--border-color, #ccc); font-weight: bold; background-color: var(--background-secondary, #f9f9f9);">
      ...
      <td style="padding: 8px;">9,493 BYN</td>
...
**Target**: Saves ~4,200 BYN while retaining Bosch quality, Pyrolysis, and Zeolite drying.
...
* **Microwave (Bosch BFL524MS0 - 1,014 BYN)**: Built-in Serie 6 microwave. Visually matches the Serie 6 oven perfectly in black glass and steel, but uses standard buttons and rotary control instead of the touch ring.
...
**Target**: Drops the total budget to **7,011 BYN** (saving nearly 50% of the primary set) while still delivering Pyrolysis, a meat probe, and huge cooking surfaces.
