...
This document organizes your kitchen renovation appliance selections into four distinct budget and feature tiers. Each item in the **Set 1** links to a dedicated detail sheet explaining why it was chosen, key technical specs, and potential concerns.

---

## 📸 Visual Column Comparison

Below is a side-by-side visualization of how the microwave and oven stack up in a column in your kitchen layout (ordered descending by price from left to right):
...
<table style="width: 100%; table-layout: fixed; border-collapse: collapse; text-align: center;">
  <thead>
    <tr style="border-bottom: 2px solid var(--border-color, #ccc);">
      ...
      <th style="width: 25%; text-align: center; padding: 10px;">⚖️ Set 2 (Bosch Manual)</th>
      <th style="width: 25%; text-align: center; padding: 10px;">⚡ Set 3 (Electrolux Touch)</th>
...
<table style="width: 100%; table-layout: fixed; border-collapse: collapse; text-align: left; word-break: break-word;">
  <thead>
    <tr style="border-bottom: 2px solid var(--border-color, #ccc); background-color: var(--background-secondary, #f9f9f9);">
      ...
      <th style="width: 22%; padding: 8px;">🌟 Set 1 (Bosch Touch)</th>
      <th style="width: 22%; padding: 8px;">⚖️ Set 2 (Bosch Manual)</th>
      <th style="width: 22%; padding: 8px;">⚡ Set 3 (Electrolux Touch)</th>
      <th style="width: 22%; padding: 8px;">🔥 Set 4 (Gorenje Manual)</th>
    </tr>
  </thead>
  <tbody>
    ...
    <tr style="border-bottom: 1px solid var(--border-color, #eee);">
      ...
      <td style="padding: 8px;">Bosch SMV8YCX02E (2,999 BYN)</td>
      <td style="padding: 8px;">Electrolux EEM48321L (1,999 BYN)</td>
      <td style="padding: 8px;">Gorenje GV643D90 (2,120 BYN)</td>
    </tr>
    <tr style="border-bottom: 1px solid var(--border-color, #eee);">
      ...
      <td style="padding: 8px;">Bosch DHL555BL (1,431 BYN)</td>
      <td style="padding: 8px;">Electrolux LFP326FB (1,066 BYN)</td>
    ...
    <tr style="border-bottom: 2px solid var(--border-color, #ccc); font-weight: bold; background-color: var(--background-secondary, #f9f9f9);">
      ...
      <td style="padding: 8px;">9,415 BYN</td>
      <td style="padding: 8px;">9,048 BYN</td>
      <td style="padding: 8px;">7,202 BYN</td>
    </tr>
  </tbody>
</table>
...
## 1. 🌟 Set 1: "Bosch Touch" (Premium & Professional)
...
## 2. ⚖️ Set 2: "Bosch Manual" (Balanced Quality)
**Target**: Total budget **9,415 BYN** — saves ~4,468 BYN compared to Set 1 while retaining Bosch quality, Pyrolysis, and premium drying.
...
* **Dishwasher (Bosch SMV8YCX02E - 2,999 BYN)**: More advanced Serie 8 model (replaces Serie 6 SMV6ECX08E) that is actually cheaper (by 123 BYN). Delivers top-tier features like Zeolite drying, metal interior, and extremely quiet operation.
...
## 3. ⚡ Set 3: "Electrolux Touch" (All-Black Glass with Full Touch)
**Target**: Total budget **9,048 BYN** — a premium, fully touch-controlled brand ecosystem that delivers pyrolysis, a food probe, matching flat touch controls, and smart mechanical hood settings.
...
* **Cooktop (Electrolux EIT61443B - 1,289 BYN)**: Standard induction cooktop with a clean black glass surface and touch sliders.
* **Dishwasher (Electrolux EEM48321L - 1,999 BYN)**: Premium 800 Series fully integrated dishwasher. Features **TimeBeam** (projects the remaining cycle time in minutes onto the floor), a MaxiFlex 3rd cutlery rack, AirDry auto-door opening, and 8 wash programs. Replaces the unavailable KEGB9305L.
* **Hood (Electrolux LFP326FB - 1,066 BYN)**: Telescopic built-in hood in black. Replaces the LFG716R to provide manual mechanical button regulation (3 speeds, 410 m³/h capacity) without wireless Hob2Hood automation.

---

## 4. 🔥 Set 4: "Gorenje Manual" (All-Black Glass with Knobs)
**Target**: Total budget **7,202 BYN** — comparable in price to Set 3 but from a different brand ecosystem, delivering Pyrolysis, SteamAssist, a meat probe, floor light indication, and a massive 77-liter oven cavity.
