# Accent Walls & Pattern Combination

Split out of [[17_Design_and_Ergonomics/analysis/Decor_and_Finish_Selection_Technique|Decor & Finish Selection Technique]] on 2026-09-01, verbatim. **Where an accent may go, how many are allowed, and how two patterns coexist** — one decision, previously scattered across four dated sections on a page about something else.

The related decisions live on:

- [[17_Design_and_Ergonomics/analysis/Color_Harmony_and_Combination_Rules|Colour Harmony & Combination Rules]] — which already cross-references the one-accent-wall rule recorded below, and flags it as `single-account` from this channel rather than independent corroboration.
- [[17_Design_and_Ergonomics/analysis/Combining_Finishes_Wood_Metal_and_Gloss|Combining Finishes — Wood, Metal and Gloss]] — the same coexistence question for finishes rather than patterns.
- [[17_Design_and_Ergonomics/analysis/Functional_Zoning_and_Furniture_Arrangement|Functional Zoning & Furniture Arrangement]] — colour and accent used deliberately as a zoning instrument.
