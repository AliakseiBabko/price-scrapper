...
Split out of [[17_Design_and_Ergonomics/analysis/Functional_Zoning_and_Furniture_Arrangement|Functional Zoning & Furniture Arrangement]] on 2026-09-01, verbatim. **How a plan is arrived at** — the standing principles, a worked whole-apartment replan, the zone hierarchy, the verb-list method, and **the definition of what actually counts as a zone**, which is the test every plan on the sibling pages should be run against.

Siblings: [[17_Design_and_Ergonomics/analysis/Functional_Zoning_and_Furniture_Arrangement|Functional Zoning & Furniture Arrangement]] (arrangement inside a settled room) · [[17_Design_and_Ergonomics/analysis/Difficult_Room_Shapes_and_Proportion_Remedies|Difficult Room Shapes & Proportion Remedies]] (when the room itself is the problem).
