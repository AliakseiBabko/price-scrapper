# Paint Testing Protocols and Complete Working Methods

Testing before you commit: one practitioner's complete working method for choosing paint, two cautions that contradict the intuitive approach, a second and third practitioner's protocols, and the cautionary cases behind each. **Split out on 2026-09-02 under the vault's 300-line page ceiling, verbatim.**

> [!IMPORTANT]
> **These are four independent protocols that do not fully agree.** Read them together rather than adopting the first one.
...
Part of [[17_Design_and_Ergonomics/analysis/Color_Selection_Process_and_Testing|Colour Selection Process and Testing]].
