# Bathroom — Tile Installation, Sequencing & Acceptance

Split out of [[07_Bathroom/analysis/Tile_Selection_and_Layout|Tile Selection & Layout]] on 2026-09-01, verbatim. **How tile goes on, in what order, and how to check the result** — including the detachment mechanisms and the acceptance checklist. Which tile to buy is on the parent; awkward formats are on [[07_Bathroom/analysis/Tile_Cutting_Handling_and_Special_Formats|Tile Cutting, Handling & Special Formats]]; joints are on [[07_Bathroom/analysis/Tile_Grout_Selection_and_Protection|Tile Grout Selection & Protection]].
