# Entrance & Hallway — Common Mistakes

Part of [[01_Entrance/Entrance_and_Hallway_Guide|Entrance & Hallway Guide]].

- **A heavy pull-out shoe-storage drawer mounted flush against the wall
  scratched it in normal use** — build in a small standoff/spacer block
...
- **A countertop multicooker sited too close to an active cooktop melted
  ...
  layout). `single-account`. [source: [[11_Budget_and_Planning/_supporting/knowledge/sources/YT_uvUmZuXgLtU_kachanova_kitchen_in_hallway_case|YT_uvUmZuXgLtU]]]
- **No drawers at all in a compact kitchen-in-hallway layout** — an
  ...
  entirely for cabinet/counter space. `single-account`. [source: [[11_Budget_and_Planning/_supporting/knowledge/sources/YT_uvUmZuXgLtU_kachanova_kitchen_in_hallway_case|YT_uvUmZuXgLtU]]]
