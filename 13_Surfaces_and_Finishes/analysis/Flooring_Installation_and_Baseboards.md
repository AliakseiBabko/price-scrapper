# Flooring Installation, Transitions & Baseboards

## Scope

Laying it and finishing the edges: laying direction and pattern, glue-down technique, thresholds and transitions, T-moldings, expansion gaps, herringbone, and the full baseboard comparison
...
## Transitions and thresholds — moved to their own page

See **[[13_Surfaces_and_Finishes/analysis/Floor_Transitions_and_Thresholds|Floor Transitions, Thresholds and Level Changes]]**. This page keeps laying technique, baseboards, and the pattern and continuity strategies.
