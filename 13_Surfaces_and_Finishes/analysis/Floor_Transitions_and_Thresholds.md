# Floor Transitions, Thresholds and Level Changes

Where two floors meet: transition-profile choice and the case for no visible profile, floating-floor threshold sealing and why cork or sealant fails, level-transition planning and its thickness asymmetry, T-molding mechanism and removable-threshold installation technique, and the rule against bridging laminate to a wall. **Split out on 2026-09-02 under the vault's 300-line page ceiling, verbatim.**
