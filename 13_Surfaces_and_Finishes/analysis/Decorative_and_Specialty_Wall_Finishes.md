...
From the same 92-minute seminar; the combination rules are on [[17_Design_and_Ergonomics/analysis/Decor_and_Finish_Selection_Technique|Decor & Finish Selection Technique]]. `promotional_ratio: medium` — hosted in the LeDimore / de Mora showroom, which supplied the examples. [source: [[_Sources/YT_7Kk_TTxoq4g_kuzina_ornament_seminar|YT_7Kk_TTxoq4g]]]
