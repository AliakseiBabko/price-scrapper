# Decorative & Specialty Wall Finishes

## Scope

Everything that is not plain paint or plain wallpaper: decorative plaster, microcement, stretch walls, clinker and porcelain, floor-planks-on-a-wall, feature and headboard wall build-ups, and the cross-material cost ladders that compare them.
...
- [[13_Surfaces_and_Finishes/analysis/Partition_Construction_and_Wall_Erection|Partition Construction & Wall Erection]]
...
- **⚠️ Plastic or metal corner protectors («уголки») — worst, unconditionally.** "Какого бы цвета ни был уголок, это всё равно самый худший вариант" — matching them to the wallpaper does not rescue them. **She names the real reason they appear: builders use them to avoid having to get the corner straight in the first place.**
- **⚠️ Ragged-edge decorative brick — second worst, and in a corridor it inverts the problem.** She has never seen it look good: worst against plain paint, worse against wallpaper, worst of all against a pattern. **The only version that works is not a corner treatment at all** — clad the *whole* wall in slate (she names Ацтека/Aztec as having slate tile with dedicated wrap-around corner elements). **But in a narrow corridor, "вы будете изнашиваться сами"** — you catch on the rough slate instead of the corner wearing.
- **Corner pilaster («пилястра») — viable in a classical scheme, and the material decides whether it solves anything.** **Joinery is the most abrasion-resistant** — wipe it like a cabinet corner — but non-standard, harder to source, design and build, and more expensive. **A polyurethane pilaster abrades at roughly the bare corner's own rate**, so it buys appearance, not durability. Gypsum is the third option.
  - **⚠️ The strongest argument for a pilaster is renewal, and it holds for any material**: with plain wallpaper and no pilaster, refreshing the worn corner means stripping and re-hanging **both** walls. With a pilaster you repaint the pilaster and leave the wallpaper alone.
  - **Detail easily missed: the pilaster must stand on a plinth block («каблучок») for the baseboard to die into.** She states it as a general rule — always resolve the baseboard junction against whatever element lands on the corner.
- **Joinery wall panels** — listed in the same family, no separate reasoning given.
- **Porcelain / large-format tile inserts at the corner**, using the tile system's own trims. **The metal tile-edge trim is acceptable here** and she is explicit that this is not the same thing as option 1: "это совсем не то же самое, что поставить просто металлический уголок на углу." The trim belongs to a tile system rather than being stuck onto a painted wall.
- **Liquid wallpaper («жидкие обои») — genuinely restorable in the worn patch**, coming back "почти как новое." Her objection is taste, not performance: "не очень интерьерный вариант," better suited to offices.
- **⚠️ Paintable wallpaper — do not count on the obvious repair.** Even with leftover paint from the original batch, a touched-up patch at the corner **will be visible.**
...
- **⚠️ Trellis / "imperial trellis" («имперская решётка») — she rates it above bolder geometrics for interior use, with a mechanism**: the drawing is thin enough to read as transparent, **the ground shows through, and the result is airy.** Very common in American interiors.
  - **⚠️ Combination caution with a stated failure mode**: because trellis is fine and graphic, **pairing it with pronounced geometric ornament (circles, squares) risks the geometry visually "eating" it.** Pair it with floral/organic patterns or plain-colour fields instead — **and if it must sit beside another geometric, that one has to be finer than the trellis.**
  - **Style compatibility**: classical, neoclassical and simplified English-classical schemes. **Badly in fusion or emphatically contemporary work** — "contemporary этого не сделаешь." In fusion it needs a strong counterweight so it reads as a deliberate bright classical accent.
- **Meander («меандр») is a ribbon ornament, not a fill** — for framing and bordering, usually a contrasting graphic on a plain rather than coloured ground.
- **Damask («дамаск») — the name misleads.** Not originally from Damascus: the silk-thread fabric came from China along the Silk Road and reached Russia via that city. **Historically it also carried animal and bird motifs, not only floral.** Almost always fabric or wallpaper, and suited to classical rather than contemporary schemes.
- **⚠️ Ikat («икат») — the white stripe is the authenticity marker.** Genuine ikat is woven, not printed: threads are bundled and dyed *before* weaving. On a 2×2 m loom, when the cloth ends there is **a white band and the pattern loses symmetry** — early motifs are symmetrical and later ones drift. **That irregularity is the sign of the real thing**, and fashion houses keep it rather than pattern-matching it away.
- **Paisley / «индийский огурец»** — 17th-century in origin, reaching Europe in the 19th, where it became a marker of English interiors as imported eastern exotica.
- **A stylisation device worth naming**: a flower drawn simultaneously in elevation and from above, so both the face and the centre of the bloom read. Common in damask and in ornament generally.
- **Material imitation is endorsed, not apologised for** — tile imitating wood, wallpaper imitating fabric, fabric imitating stone or marble. "На рынке очень много таких вариантов."
...
- **⚠️ Trendy textured/patterned tile critique bundle, with specific comparative lifespan figures, genuinely valuable, record in full**: cement tile — porous, absorbs moisture/oil/wine even with sealant, needs re-sealing every **6-12 months** or it stains/darkens; glass mosaic — many grout joints, each collects grime, needs constant cleaning; Moroccan/zellige tile — irregular by design (celebrated as an aesthetic feature by top manufacturers themselves) but the irregular joint width traps dirt over time, reads as "dirty" rather than characterful specifically in a kitchen or shower context. **Comparative durability claim, worth quoting exactly**: high-grade porcelain tile/slab lasts **20-25 years** of active use without losing appearance, while a solid stone slab lasts as long as the house itself with minimal upkeep.
- **⚠️ Ornate/baroque decorative-element critique, named as "pseudo-luxury" especially in factory execution — names Jean-Michel Frank and Émile-Jacques Ruhlmann as examples of ornament done well (Art Deco masters, flag per cultural-reference filter)**: heavy cornices, carved mouldings, and applied decorative filler are critiqued as ornament substituting for form rather than reinforcing it; Frank and Ruhlmann's ornament is architecturally integrated into a piece's/surface's own form rather than applied on top. Core principle: ornament should reinforce form, never substitute for it or fill empty space.
- **⚠️ Gold/brass overuse critique, plus a time-sensitive trend observation**: gold/brass on every surface (faucets, handles, furniture bodies, light fixtures) reads as "showy"/"like a Vegas casino" rather than luxurious. Gold works only as a rare accent (one large object — chandelier, art object, a piece of furniture — can carry shine); everything else should stay in calmer materials (matte nickel, black metal, patinated brass). **Explicitly flags brass itself as becoming overused/turning into a new cliché, with the stated 2026 trend movement toward more complex finishes/new materials, brass receding** — tag as a time-sensitive trend observation, not a durable rule.
- **⚠️ Custom murals/fresco wall art — a nuanced, honestly-uncertain position, worth recording as a genuine open question rather than a flat rule**: acknowledges murals can genuinely elevate a space into a real art object, but explicitly states this "locks" the room into a specific stylistic moment that can read as dated/trend-fixed within a few years. His own honest uncertainty, quoted directly: **"пока не очевидно, как относиться к подобным решениям"** ("it's not obvious yet how to feel about this technique"). Contrasts this with neutral textures + movable/replaceable art objects, which can be swapped over time to refresh a room's feel without capital renovation. Recorded as his stated open uncertainty, not a confident rule either way.
