...
**Full baseboard-type compatibility list, added 2026-08-28**: a concealed door isn't limited to shadow-gap baseboard specifically — any baseboard type that's either flush with the wall or genuinely thin works, per Konstantin Kruglov/Ontario's structured seven-type baseboard comparison: shadow baseboard, concealed-mount baseboard, aluminum baseboard (only a few mm proud of the wall), and micro-baseboard/corner strip are all compatible; PVC, the rigid pre-finished family (MDF/duropolymer/veneer), and tile baseboard are not (they protrude too far and catch the door leaf on opening). See [[13_Surfaces_and_Finishes/Flooring_Guide|Flooring Guide]] for the full cost/wear/cleaning comparison across all seven baseboard types. [source: [[11_Budget_and_Planning/_supporting/knowledge/sources/YT_a-e5f7yQDRY_kruglov_baseboard_types_2024|YT_a-e5f7yQDRY]]]
