...
The two applied-finish families in one place: durability and skill requirements, substrate tolerance, budget DIY routes, reveals and flush junctions, cabinet fronts, wet-area use, and the rule against plaster-imitation wallpaper. **Split out on 2026-09-02, verbatim.** Its parent was merged out of dated batch headings first, then this coherent group was moved whole — merge before extract, per `00_Master/wiki_page_format.md`.
