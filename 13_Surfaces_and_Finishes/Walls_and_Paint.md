...
- **First course is always laid on cement-sand mortar, never foam-glue, even in a foam-glue-bonded wall** — raw floor slabs are never perfectly level, and foam-glue bonds fast but doesn't correct leveling errors; all leveling work must happen at the first course so everything above it can be laid quickly with no further leveling. [source: [[11_Budget_and_Planning/_supporting/knowledge/sources/YT_g7Cuj1p-0CA_masonry_first_course_leveling_231|g7Cuj1p-0CA_masonry_firs]]]
- **Survey before deciding whether beacon-based leveling is needed at all**: a small measured spread (~5mm) across a run needs no beacons, just a uniform mortar layer; a larger spread (~3cm) needs full beacon leveling. Don't default straight to beacons without checking first. [source: [[11_Budget_and_Planning/_supporting/knowledge/sources/YT_g7Cuj1p-0CA_masonry_first_course_leveling_231|g7Cuj1p-0CA_masonry_firs]]]
- **Beacon-leveling method**: find the run's highest point via laser survey, set the first beacon there as the reference/"zero," then match every other beacon's laser-to-top distance to it using a rigid straightedge (not a tape measure, which introduces error). Use a rigid beacon type, never cheap flexible foil beacons. [source: [[11_Budget_and_Planning/_supporting/knowledge/sources/YT_g7Cuj1p-0CA_masonry_first_course_leveling_231|g7Cuj1p-0CA_masonry_firs]]]
- **Sequencing rule: always start block-laying from an existing fixed wall toward a free corner, never the reverse** — a shortfall/excess at the unconstrained far end is trivially fixed later (plaster if short, saw-trim if long); starting from a free corner risks an awkward sliver cut. [source: [[11_Budget_and_Planning/_supporting/knowledge/sources/YT_Qs_FxXdsq40_masonry_glue_foam_technique_260|Qs_FxXdsq40_masonry_glue]]]
- **Never pre-cut the first course around planned door/window openings** — lay it continuous, cut openings afterward with a reciprocating saw once the row is set. [source: [[11_Budget_and_Planning/_supporting/knowledge/sources/YT_Qs_FxXdsq40_masonry_glue_foam_technique_260|Qs_FxXdsq40_masonry_glue]]]
- **Client-facing wall-flatness acceptance threshold, explicit numbers**: gaps up to 5-7mm against a straightedge are acceptable (plaster-correctable); **gaps of 15mm or more should never be accepted — insist on a rebuild.** The raw first-course platform itself, before any further courses are laid, should be noticeably tighter (a couple mm or less). [source: [[11_Budget_and_Planning/_supporting/knowledge/sources/YT_Qs_FxXdsq40_masonry_glue_foam_technique_260|Qs_FxXdsq40_masonry_glue]]]
- **Never sledgehammer-test a finished wall's strength** — judge qualitatively instead: straight, no cracks, visible foam-glue joints between blocks. [source: [[11_Budget_and_Planning/_supporting/knowledge/sources/YT_Qs_FxXdsq40_masonry_glue_foam_technique_260|Qs_FxXdsq40_masonry_glue]]]
...
- **A wall-plane offset (a step where two wall segments' faces don't align) has a hard ~40mm threshold for what plaster can fix.** Up to roughly 3-4cm, masonry infill and drywall framing are both too large/thin to use, but a plaster leveling coat still works. Past ~40mm, the required leveling coat becomes too thick to hold (it will detach) and, even if it doesn't, cures too slowly and delays downstream work. **Rule: past ~40mm of wall-plane offset, demolish and rebuild that wall section to the correct plane** rather than trying to level it with any surface material. [source: [[11_Budget_and_Planning/_supporting/knowledge/sources/YT_p-6OI34C6bw_seven_reasons_demolish_developer_walls_304|p-6OI34C6bw_seven_reason]]]
- **A partition wall segment built without proper corner tie-in to adjoining walls/lintels (including tie-in to exterior walls, not just other partitions) will develop cracks along every un-tied joint over time, no matter how the seam is later patched or bridged.** Rule: every rebuilt or newly built partition must be tied in at every corner it meets. [source: [[11_Budget_and_Planning/_supporting/knowledge/sources/YT_p-6OI34C6bw_seven_reasons_demolish_developer_walls_304|p-6OI34C6bw_seven_reason]]]
- **A pantry/storage-closet or triangular residual room with narrow bounding-wall reveals (roughly ≤45-98cm depending on the adjoining fixture) can become almost entirely unusable for storage even when the room's total floor area looks sufficient** — the deciding factor is reveal width at the opening, not raw square footage. Independently corroborated across two projects (a pantry example and a triangular-room closet example). [source: [[11_Budget_and_Planning/_supporting/knowledge/sources/YT_p-6OI34C6bw_seven_reasons_demolish_developer_walls_304|p-6OI34C6bw_seven_reason]]] [source: [[11_Budget_and_Planning/_supporting/knowledge/sources/YT_cO56TxjBifo_designer_lost_room_1.9m_291|cO56TxjBifo_designer_los]]]
- **Thin partition walls are repeatedly flagged as inadequate for soundproofing at two independently observed thicknesses, with no "adequate" thickness yet established by any source processed so far: 80mm (a paz-greben/tongue-and-groove gypsum-block partition, demonstrated visibly flexing and audibly transmitting sound under hand/foot pressure, eventually cracking even under reinforcing fabric) and 100mm (flagged the same way in a separate project's design review).** Treat any partition at or below 100mm as a soundproofing risk pending a source that states a confirmed-adequate thickness. [source: [[11_Budget_and_Planning/_supporting/knowledge/sources/YT_p-6OI34C6bw_seven_reasons_demolish_developer_walls_304|p-6OI34C6bw_seven_reason]]] [source: [[11_Budget_and_Planning/_supporting/knowledge/sources/YT_3Otf-oBcMqg_lost_30pct_apartment_298|3Otf-oBcMqg_lost_30pct_a]]]
...
> [!NOTE]
> `single-account`, three more videos from the same July-November 2023 narrated-planning-logic cluster. [sources: [[11_Budget_and_Planning/_supporting/knowledge/sources/YT_HVSZh0lH9hk_craziest_two_room_230|note 1]], [[11_Budget_and_Planning/_supporting/knowledge/sources/YT_ZVoExA0t6nI_useless_3bedroom_223|note 2]], [[11_Budget_and_Planning/_supporting/knowledge/sources/YT_1pU60p0Jh3A_worst_two_room_228|note 3]]]

- **⚠️ Wall-squareness DIY diagnostic**: place any true rectangular reference object (a book, a level, a sheet of drywall — anything with real 90° corners) into a suspect corner and rotate it flush against one wall — the gap or overlap visible at the other edge reveals exactly how far the corner deviates from true 90°, no angle-finder needed. [source: [[11_Budget_and_Planning/_supporting/knowledge/sources/YT_HVSZh0lH9hk_craziest_two_room_230|HVSZh0lH9hk_craziest_two]]]
...
> [!NOTE]
> Region level 2 only (channel branding, no city spoken). Low promotional ratio. Studio explainer format, no on-site case study. [source: [[11_Budget_and_Planning/_supporting/knowledge/sources/YT_66pn-nIOJkg_petrishin_paint_vs_wallpaper|66pn-nIOJkg]]]
