...
async function main() {
  ...
  const url = `https://catalog.onliner.by/sdapi/catalog.api/search/dishwasher?mfr[0]=bosch&page=1`;
  ...
  try {
    ...
    if (data && data.products) {
      console.log(`Found ${data.products.length} Bosch dishwashers on page 1:`);
