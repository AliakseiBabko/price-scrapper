...
async function main() {
  ...
  const url = `https://catalog.onliner.by/sdapi/catalog.api/search/hob_cooker?mfr[0]=electrolux&page=1`;
  ...
  try {
    ...
    if (data && data.products) {
      console.log(`Found ${data.products.length} Electrolux hobs on page 1:`);
