...
- [[00_Master/Validator_Design_Discipline|Validator Design Discipline]] — §3's anti-over-engineering rule reads directly onto it. A cross-reference for the reader, not a routing destination: nothing from this note was written there.
