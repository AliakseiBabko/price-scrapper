...
- **`_Knowledge/store/Durable_Facts.md`** — the repair-compounding (tile-unavailability) and specialist-scarcity points, general cross-cutting mistakes-and-warnings content.
